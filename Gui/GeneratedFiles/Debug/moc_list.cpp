...
QT_MOC_LITERAL(1, 5, 18), // "showstart_fromlist"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 21), // "receivestart_fromlist"
QT_MOC_LITERAL(4, 47, 26) // "on_backbutton_clicked_list"

    },
    "List\0showstart_fromlist\0\0receivestart_fromlist\0"
    "on_backbutton_clicked_list"
};
...
void List::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showstart_fromlist(); break;
        case 1: _t->receivestart_fromlist(); break;
        case 2: _t->on_backbutton_clicked_list(); break;
        default: ;
        }
        ...
        {
            using _t = void (List::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&List::showstart_fromlist)) {
                *result = 0;
                return;
            }
        }
