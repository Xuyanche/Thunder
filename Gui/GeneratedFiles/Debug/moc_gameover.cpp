...
QT_MOC_LITERAL(1, 9, 10), // "show_start"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 12), // "show_gameone"
QT_MOC_LITERAL(4, 34, 30), // "on_backbutton_clicked_gameover"
QT_MOC_LITERAL(5, 65, 33), // "on_restartbutton_clicked_game..."
QT_MOC_LITERAL(6, 99, 7) // "receive"

    },
    "gameover\0show_start\0\0show_gameone\0"
...
void gameover::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gameover::show_start)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (gameover::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gameover::show_gameone)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void gameover::show_start()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void gameover::show_gameone()
{
